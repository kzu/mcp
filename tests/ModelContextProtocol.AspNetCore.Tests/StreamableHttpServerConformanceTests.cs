...
public class StreamableHttpServerConformanceTests() : KestrelInMemoryTest(), IAsyncDisposable
{
    ...
    public async Task PostRequest_IsUnsupportedMediaType_WithoutJsonContentType()
    {
        ...
        using var response = await HttpClient.PostAsync("", new StringContent(InitializeRequest, Encoding.UTF8, "text/javascript"), TestContext.CurrentContext.CancellationToken);
    ...
    public async Task GetRequest_IsNotAcceptable_WithoutTextEventStreamAcceptHeader()
    {
        ...
        using var response = await HttpClient.GetAsync("", TestContext.CurrentContext.CancellationToken);
        Assert.Equal(HttpStatusCode.NotAcceptable, response.StatusCode);
    }
    ...
    public async Task GetRequest_IsAcceptable_WithWildcardOrAddedQualityInAcceptHeader(string acceptHeaderValue)
    {
        ...
        using var response = await HttpClient.GetAsync("", HttpCompletionOption.ResponseHeadersRead, TestContext.CurrentContext.CancellationToken);
        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
    }
    ...
    public async Task PostWithoutSessionId_NonInitializeRequest_Returns400()
    {
        ...
        using var response = await HttpClient.PostAsync("", JsonContent(ListToolsRequest), TestContext.CurrentContext.CancellationToken);
        Assert.Equal(HttpStatusCode.BadRequest, response.StatusCode);
    ...
    public async Task InitializeRequest_Matches_CustomRoute()
    {
        ...
        HttpClient.DefaultRequestHeaders.Accept.Add(new("application/json"));
        HttpClient.DefaultRequestHeaders.Accept.Add(new("text/event-stream"));
        using var response = await HttpClient.PostAsync("/custom-route", JsonContent(InitializeRequest), TestContext.CurrentContext.CancellationToken);
        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
    }
    ...
    public async Task PostWithSingleNotification_IsAccepted_WithEmptyResponse()
    {
        ...
        var response = await HttpClient.PostAsync("", JsonContent(ProgressNotification("1")), TestContext.CurrentContext.CancellationToken);
        Assert.Equal(HttpStatusCode.Accepted, response.StatusCode);
        Assert.Equal("", await response.Content.ReadAsStringAsync(TestContext.CurrentContext.CancellationToken));
    }
    ...
    public async Task SingleJsonRpcRequest_ThatThrowsIsHandled_WithCompleteSseResponse()
    {
        ...
        var response = await HttpClient.PostAsync("", JsonContent(CallTool("throw")), TestContext.CurrentContext.CancellationToken);
...
#pragma warning restore MCPEXP002
        ...
        using var getResponse = await HttpClient.GetAsync("", HttpCompletionOption.ResponseHeadersRead, TestContext.CurrentContext.CancellationToken);
        ...
        await server.SendNotificationAsync("test-method", TestContext.CurrentContext.CancellationToken);
...
#pragma warning restore MCPEXP002
        ...
        var exception = await Record.ExceptionAsync(() =>
            server.SendNotificationAsync("test-method", TestContext.CurrentContext.CancellationToken));
    ...
    public async Task SecondGetRequests_IsRejected_AsBadRequest()
    {
        ...
        await CallInitializeAndValidateAsync();
        using var getResponse1 = await HttpClient.GetAsync("", HttpCompletionOption.ResponseHeadersRead, TestContext.CurrentContext.CancellationToken);
        using var getResponse2 = await HttpClient.GetAsync("", HttpCompletionOption.ResponseHeadersRead, TestContext.CurrentContext.CancellationToken);
    ...
    public async Task DeleteRequest_CompletesSession_WhichIsNoLongerFound()
    {
        ...
        await CallInitializeAndValidateAsync();
        await CallEchoAndValidateAsync();
        await HttpClient.DeleteAsync("", TestContext.CurrentContext.CancellationToken);

        using var response = await HttpClient.PostAsync("", JsonContent(EchoRequest), TestContext.CurrentContext.CancellationToken);
        Assert.Equal(HttpStatusCode.NotFound, response.StatusCode);
    }
    ...
    public async Task DeleteRequest_CompletesSession_WhichCancelsLongRunningToolCalls()
    {
        ...
        var getResponse = await HttpClient.GetAsync("", HttpCompletionOption.ResponseHeadersRead, TestContext.CurrentContext.CancellationToken);
        ...
        var sseResponseBody = await getResponse.Content.ReadAsStringAsync(TestContext.CurrentContext.CancellationToken);
        ...
        foreach (var response in responseHeaders)
        {
            await Assert.ThrowsAsync<HttpRequestException>(async () => await response.Content.ReadAsByteArrayAsync(TestContext.CurrentContext.CancellationToken));
        }
    }
    ...
    public async Task Progress_IsReported_InSameSseResponseAsRpcResponse()
    {
        ...
        using var response = await HttpClient.PostAsync("", JsonContent(CallToolWithProgressToken("progress")), TestContext.CurrentContext.CancellationToken);
        Assert.Equal(HttpStatusCode.OK, response.StatusCode);
...
#pragma warning restore MCPEXP002
        ...
        {
            var response = await HttpClient.PostAsync("", JsonContent(CallTool("async-local-session")), TestContext.CurrentContext.CancellationToken);
    ...
    public async Task McpServer_UsedOutOfScope_CanSendNotifications()
    {
        ...
        using var getResponse = await HttpClient.GetAsync("", HttpCompletionOption.ResponseHeadersRead, TestContext.CurrentContext.CancellationToken);
        using var response = await HttpClient.PostAsync("", JsonContent(SubscribeToResource("file:///test")), TestContext.CurrentContext.CancellationToken);
        var rpcResponse = await AssertSingleSseResponseAsync(response);
        ...
        await capturedServer.SendNotificationAsync(NotificationMethods.ResourceUpdatedNotification, TestContext.CurrentContext.CancellationToken);
    ...
    {
        var responseStream = await responseContent.ReadAsStreamAsync(TestContext.CurrentContext.CancellationToken);
        await foreach (var sseItem in SseParser.Create(responseStream).EnumerateAsync(TestContext.CurrentContext.CancellationToken))
        {
    ...
    private static async Task<JsonRpcResponse> AssertSingleSseResponseAsync(HttpResponseMessage response)
    {
        ...
        var sseItem = Assert.Single(await ReadSseAsync(response.Content).ToListAsync(TestContext.CurrentContext.CancellationToken));
