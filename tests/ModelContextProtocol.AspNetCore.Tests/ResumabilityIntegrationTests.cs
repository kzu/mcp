...
public class ResumabilityIntegrationTests : ResumabilityIntegrationTestsBase
{
    ...
    public async Task PostResponse_EndsAndSseEventStreamWriterIsDisposed_WhenWriteEventAsyncIsCanceled()
    {
        ...
        using var callCts = CancellationTokenSource.CreateLinkedTokenSource(TestContext.CurrentContext.CancellationToken);
        ...
        await blockingStore.WriteEventBlockedTask.WaitAsync(TestContext.CurrentContext.CancellationToken);
        ...
        using var timeoutCts = CancellationTokenSource.CreateLinkedTokenSource(TestContext.CurrentContext.CancellationToken);
