...
public class HttpTaskIntegrationTests : KestrelInMemoryTest
{
    ...
    public async Task GetTaskAsync_ReturnsTaskStatus_WhenTaskExistsAsync()
    {
        ...
        var task = await client.GetTaskAsync(tasks[0].TaskId, cancellationToken: TestContext.CurrentContext.CancellationToken);
    ...
    public async Task CancelTaskAsync_CancelsTask_WhenTaskIsRunningAsync()
    {
        ...
        // Act - Cancel the task
        var cancelledTask = await client.CancelTaskAsync(tasks[0].TaskId, cancellationToken: TestContext.CurrentContext.CancellationToken);
    ...
    public async Task GetTaskResultAsync_ReturnsResult_WhenTaskCompletesAsync()
    {
        ...
        var result = await client.GetTaskResultAsync(tasks[0].TaskId, cancellationToken: TestContext.CurrentContext.CancellationToken);
    ...
    public async Task TasksIsolated_BetweenSessions_WhenMultipleClientsConnectAsync()
    {
        ...
        var client1Tasks = await client1.ListTasksAsync(cancellationToken: TestContext.CurrentContext.CancellationToken);
        var client2Tasks = await client2.ListTasksAsync(cancellationToken: TestContext.CurrentContext.CancellationToken);
