...
public partial class XmlToDescriptionGeneratorTests
{
    ...
    public void Caching_WithIdenticalCompilation_AllOutputsCached()
    {
        ...
        // Run #1
        driver = driver.RunGenerators(compilation, TestExecutionContext.Current.CancellationToken);
    ...
    public void Caching_WithNewCompilationSameSource_OutputsCached()
    {
        ...
        driver = driver.RunGenerators(compilation1, TestExecutionContext.Current.CancellationToken);
        var result1 = driver.GetRunResult();
        Assert.Single(result1.Results);
        ...
        driver = driver.RunGenerators(compilation2, TestExecutionContext.Current.CancellationToken);
        var result2 = driver.GetRunResult();
        Assert.Single(result2.Results);
    ...
    public void Caching_WithUnrelatedFileChange_McpMethodCached()
    {
        ...
        driver = driver.RunGenerators(CreateCompilation(McpSource, UnrelatedSource1), TestExecutionContext.Current.CancellationToken);
        var result1 = driver.GetRunResult();
        Assert.Single(result1.Results);
        var output1 = result1.Results[0].GeneratedSources[0].SourceText.ToString();

        // Run #2 with MCP file + MODIFIED unrelated file
        driver = driver.RunGenerators(CreateCompilation(McpSource, UnrelatedSource2), TestExecutionContext.Current.CancellationToken);
        var result2 = driver.GetRunResult();
        Assert.Single(result2.Results);
    ...
    public void Caching_WithXmlDocChange_OutputRegenerated()
    {
        ...
        // Run #1
        driver = driver.RunGenerators(CreateCompilation(Source1), TestExecutionContext.Current.CancellationToken);
        var result1 = driver.GetRunResult();
        var output1 = result1.Results[0].GeneratedSources[0].SourceText.ToString();
        Assert.Contains("Original description", output1);

        // Run #2 with modified XML docs
        driver = driver.RunGenerators(CreateCompilation(Source2), TestExecutionContext.Current.CancellationToken);
        var result2 = driver.GetRunResult();
        var output2 = result2.Results[0].GeneratedSources[0].SourceText.ToString();
    ...
    public void Caching_MultipleMethodsAcrossFiles_IndependentCaching()
    {
        ...
        // Run #1
        driver = driver.RunGenerators(CreateCompilation(File1, File2Original), TestExecutionContext.Current.CancellationToken);
        var result1 = driver.GetRunResult();
        Assert.Single(result1.Results[0].GeneratedSources);

        // Run #2 - only File2 changed
        driver = driver.RunGenerators(CreateCompilation(File1, File2Modified), TestExecutionContext.Current.CancellationToken);
        var result2 = driver.GetRunResult();
        Assert.Single(result2.Results[0].GeneratedSources);
