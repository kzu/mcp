...
public partial class UrlElicitationTests() : ClientServerTestBase()
{
    ...
    public async Task Can_Elicit_OutOfBand_With_Url()
    {
        ...
        var result = await client.CallToolAsync("TestUrlElicitation", cancellationToken: TestExecutionContext.Current.CancellationToken);
        ...
        var notifiedElicitationId = await completionNotification.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task UrlElicitation_User_Can_Decline()
    {
        ...
        var result = await client.CallToolAsync("TestUrlElicitationDecline", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task UrlElicitation_User_Can_Cancel()
    {
        ...
        var result = await client.CallToolAsync("TestUrlElicitationCancel", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task UrlElicitation_Defaults_To_Unsupported_When_Handler_Provided()
    {
        ...
        var result = await client.CallToolAsync("ProbeUrlCapability", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task FormElicitation_Defaults_To_Supported_When_Handler_Provided()
    {
        ...
        var result = await client.CallToolAsync("ProbeFormCapability", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task UrlElicitation_BlankCapability_Allows_Only_Form()
    {
        ...
        var urlResult = await client.CallToolAsync("ProbeUrlCapability", cancellationToken: TestExecutionContext.Current.CancellationToken);
        ...
        var formResult = await client.CallToolAsync("ProbeFormCapability", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task UrlElicitation_Requires_ElicitationId_For_Url_Mode()
    {
        ...
        var result = await client.CallToolAsync("TestUrlElicitationMissingId", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task UrlElicitationRequired_Exception_Propagates_To_Client()
    {
        ...
        var exception = await Assert.ThrowsAsync<UrlElicitationRequiredException>(
            async () => await client.CallToolAsync("TestUrlElicitationRequired", cancellationToken: TestExecutionContext.Current.CancellationToken));
    ...
    public async Task FormElicitation_Requires_RequestedSchema()
    {
        ...
        var result = await client.CallToolAsync("TestFormElicitationMissingSchema", cancellationToken: TestExecutionContext.Current.CancellationToken);
