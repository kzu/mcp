...
public partial class ElicitationTypedTests : ClientServerTestBase
{
    ...
    public async Task Can_Elicit_Typed_Information()
    {
        ...
        var result = await client.CallToolAsync("TestElicitationTyped", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Elicit_Typed_Respects_NamingPolicy()
    {
        ...
        var result = await client.CallToolAsync("TestElicitationCamelForm", cancellationToken: TestExecutionContext.Current.CancellationToken);
        Assert.Equal("success", (result.Content[0] as TextContentBlock)?.Text);
    }
    ...
    public async Task Elicit_Typed_With_Unsupported_Property_Type_Throws()
    {
        ...
        var ex = await Assert.ThrowsAsync<McpProtocolException>(async() =>
            await client.CallToolAsync("TestElicitationUnsupportedType", cancellationToken: TestExecutionContext.Current.CancellationToken));
    ...
    public async Task Elicit_Typed_With_Nullable_Property_Type_Throws()
    {
        ...
        var ex = await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.CallToolAsync("TestElicitationNullablePropertyForm", cancellationToken: TestExecutionContext.Current.CancellationToken));
    }
    ...
    public async Task Elicit_Typed_With_NonObject_Generic_Type_Throws()
    {
        ...
        var ex = await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.CallToolAsync("TestElicitationNonObjectGenericType", cancellationToken: TestExecutionContext.Current.CancellationToken));
    ...
    {
        Assert.Skip("Requires AIJsonUtilities to support extracting default values from optional parameters");
        ...
        var result = await client.CallToolAsync("TestElicitationWithDefaults", cancellationToken: TestExecutionContext.Current.CancellationToken);
        Assert.Equal("success", (result.Content[0] as TextContentBlock)?.Text);
    }
}
