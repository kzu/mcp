...
public class McpServerBuilderExtensionsRequestFilterTests() : ClientServerTestBase()
{
    ...
    public async Task AddListResourceTemplatesFilter_Logs_When_ListResourceTemplates_Called()
    {
        ...
        await client.ListResourceTemplatesAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddCallToolFilter_Logs_When_CallTool_Called()
    {
        ...
        await client.CallToolAsync("test_tool_method", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddCallToolFilter_Catches_Exception_From_Tool()
    {
        ...
        var result = await client.CallToolAsync("throwing_tool_method", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddListPromptsFilter_Logs_When_ListPrompts_Called()
    {
        ...
        await client.ListPromptsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddGetPromptFilter_Logs_When_GetPrompt_Called()
    {
        ...
        await client.GetPromptAsync("test_prompt_method", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddListResourcesFilter_Logs_When_ListResources_Called()
    {
        ...
        await client.ListResourcesAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddReadResourceFilter_Logs_When_ReadResource_Called()
    {
        ...
        await client.ReadResourceAsync("test://resource/123", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddCompleteFilter_Logs_When_Complete_Called()
    {
        ...
        await client.CompleteAsync(reference, "argument", "value", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddSubscribeToResourcesFilter_Logs_When_SubscribeToResources_Called()
    {
        ...
        await client.SubscribeToResourceAsync("test://resource/123", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddUnsubscribeFromResourcesFilter_Logs_When_UnsubscribeFromResources_Called()
    {
        ...
        await client.UnsubscribeFromResourceAsync("test://resource/123", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task AddSetLoggingLevelFilter_Logs_When_SetLoggingLevel_Called()
    {
        ...
        await client.SetLoggingLevelAsync(LoggingLevel.Info, cancellationToken: TestExecutionContext.Current.CancellationToken);
