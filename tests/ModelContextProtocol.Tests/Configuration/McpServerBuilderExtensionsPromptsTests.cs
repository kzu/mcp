...
{
    public McpServerBuilderExtensionsPromptsTests()
        : base()
    {
    }
    ...
    public async Task Can_List_And_Call_Registered_Prompts()
    {
        ...
        var result = await prompt.GetAsync(new Dictionary<string, object?>() { ["message"] = "hello" }, cancellationToken: TestExecutionContext.Current.CancellationToken);
        ...
        result = await prompt.GetAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Can_Be_Notified_Of_Prompt_Changes()
    {
            ...
            }))
        {
            ...
            prompts = await client.ListPromptsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
