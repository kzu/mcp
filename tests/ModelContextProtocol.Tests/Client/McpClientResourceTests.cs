...
public class McpClientResourceTests : ClientServerTestBase
{
    ...
    public async Task ReuseResourceDefinition_AcrossDifferentClients_ReadsSuccessfully()
    {
        Resource resourceDefinition;
        {
            ...
            var resources = await client1.ListResourcesAsync(cancellationToken: TestContext.CurrentContext.CancellationToken);
    ...
    public async Task ReadAsync_WithRequestOptions_PassesMetaToServer()
    {
        ...
        var result = await resource.ReadAsync(options: requestOptions, cancellationToken: TestContext.CurrentContext.CancellationToken);
