...
{
    public McpClientTaskMethodsTests()
        : base()
    {
    }
    ...
    public async Task GetTaskAsync_ThrowsForInvalidTaskId()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(async () =>
            await client.GetTaskAsync("", cancellationToken: TestExecutionContext.Current.CancellationToken));
    }
    ...
    public async Task GetTaskResultAsync_ReturnsDeserializedResult()
    {
        ...
        JsonElement result = await client.GetTaskResultAsync(taskId, cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task GetTaskResultAsync_ThrowsForInvalidTaskId()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(async () =>
            await client.GetTaskResultAsync("", cancellationToken: TestExecutionContext.Current.CancellationToken));
    }
    ...
    public async Task ListTasksAsync_LowLevel_ReturnsRawResult()
    {
        ...
        // Use low-level API
        var result = await client.ListTasksAsync(new ListTasksRequestParams(), TestExecutionContext.Current.CancellationToken);
    ...
    public async Task ListTasksAsync_LowLevel_ThrowsForNullParams()
    {
        ...
        await Assert.ThrowsAsync<ArgumentNullException>(async () =>
            await client.ListTasksAsync((ListTasksRequestParams)null!, TestExecutionContext.Current.CancellationToken));
    }
    ...
    public async Task CancelTaskAsync_CancelsRunningTask()
    {
        ...
        // Cancel the task
        var canceledTask = await client.CancelTaskAsync(taskId, cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task CancelTaskAsync_ThrowsForInvalidTaskId()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(async () =>
            await client.CancelTaskAsync("", cancellationToken: TestExecutionContext.Current.CancellationToken));
    }
