...
public class McpClientTaskSamplingElicitationTests : ClientServerTestBase
{
    ...
    public async Task Client_WithTaskStore_CanExecuteSamplingAsTask()
    {
        ...
        do
        {
            ...
            taskStatus = await Server.GetTaskAsync(mcpTask.TaskId, TestExecutionContext.Current.CancellationToken);
        }
        ...
        var result = await Server.GetTaskResultAsync<CreateMessageResult>(
            mcpTask.TaskId, cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Client_WithTaskStore_CanExecuteElicitationAsTask()
    {
        ...
        await elicitationCompleted.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Client_CanCancelTasks()
    {
        ...
        await samplingStarted.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);

        // Act - Cancel the task
        var cancelledTask = await Server.CancelTaskAsync(mcpTask.TaskId, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Client_TaskStatusNotifications_SentWhenEnabled()
    {
        ...
        await Task.WhenAll(
            workingNotificationReceived.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken),
            completedNotificationReceived.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken));
    ...
    public async Task Client_SamplingHandlerException_ResultsInFailedTask()
    {
        ...
        await samplingAttempted.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Client_ElicitationHandlerException_ResultsInFailedTask()
    {
        ...
        await elicitationAttempted.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
