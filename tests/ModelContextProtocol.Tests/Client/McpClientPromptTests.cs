...
public class McpClientPromptTests : ClientServerTestBase
{
    ...
    public async Task ReusePromptDefinition_AcrossDifferentClients_InvokesSuccessfully()
    {
        Prompt promptDefinition;
        {
            ...
            var prompts = await client1.ListPromptsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task GetAsync_WithRequestOptions_PassesMetaToServer()
    {
        ...
        var result = await prompt.GetAsync(options: requestOptions, cancellationToken: TestExecutionContext.Current.CancellationToken);
