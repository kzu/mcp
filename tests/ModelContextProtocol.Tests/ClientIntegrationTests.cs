...
public partial class ClientIntegrationTests : LoggedTest
{
    ...
    private static ClientIntegrationTestFixture _fixture = null!;

    [OneTimeSetUp]
    public static void OneTimeSetUp()
    {
        _fixture = new ClientIntegrationTestFixture();
    }
    ...
    [TestCaseSource(nameof(GetClients))]
    public async Task ConnectAndPing_Stdio(string clientId)
    {
        ...
        await client.PingAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task CallTool_Stdio_EchoSessionId_ReturnsEmpty()
    {
        ...
        var result = await client.CallToolAsync("echoSessionId", cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task CallTool_Stdio_ViaAIFunction_EchoServer(string clientId)
    {
        ...
        // act
        await using var client = await _fixture.CreateClientAsync(clientId);
        var aiFunctions = await client.ListToolsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
        var echo = aiFunctions.Single(t => t.Name == "echo");
        var result = await echo.InvokeAsync(new() { ["message"] = "Hello MCP!" }, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task ListPrompts_Stdio(string clientId)
    {
        ...
        // act
        await using var client = await _fixture.CreateClientAsync(clientId);
        var prompts = await client.ListPromptsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task GetPrompt_Stdio_SimplePrompt(string clientId)
    {
        ...
        // act
        await using var client = await _fixture.CreateClientAsync(clientId);
        var result = await client.GetPromptAsync("simple-prompt", null, cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task GetPrompt_Stdio_ComplexPrompt(string clientId)
    {
        ...
        var result = await client.GetPromptAsync("args-prompt", arguments, cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task GetPrompt_NonExistent_ThrowsException(string clientId)
    {
        ...
        await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.GetPromptAsync("non_existent_prompt", null, cancellationToken: TestExecutionContext.Current.CancellationToken));
    }
    ...
    public async Task ListResourceTemplates_Stdio(string clientId)
    {
        ...
        IList<McpClientResourceTemplate> allResourceTemplates = await client.ListResourceTemplatesAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task ListResources_Stdio(string clientId)
    {
        ...
        IList<McpClientResource> allResources = await client.ListResourcesAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task ReadResource_Stdio_TextResource(string clientId)
    {
        ...
        var result = await client.ReadResourceAsync(textResource.Uri, null, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task ReadResource_Stdio_BinaryResource()
    {
        ...
        var result = await client.ReadResourceAsync("test://static/resource/2", null, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task SubscribeResource_Stdio()
    {
        ...
        await client.SubscribeToResourceAsync("test://static/resource/1", null, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task UnsubscribeResource_Stdio()
    {
        ...
        // unsubscribe
        await client.UnsubscribeFromResourceAsync("test://static/resource/1", null, TestExecutionContext.Current.CancellationToken);
    }
    ...
    public async Task Complete_Stdio_ResourceTemplateReference(string clientId)
    {
        ...
        // act
        await using var client = await _fixture.CreateClientAsync(clientId);
        var templates = await client.ListResourceTemplatesAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    //    // Connect
    //    await client.ConnectAsync(TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Notifications_Stdio(string clientId)
    {
        ...
        await client.SendNotificationAsync(NotificationMethods.RootsListChangedNotification, cancellationToken: TestExecutionContext.Current.CancellationToken);
        await client.SendNotificationAsync("test/notification", new TestNotification { Test = true }, cancellationToken: TestExecutionContext.Current.CancellationToken, serializerOptions: JsonContext3.Default.Options);
    ...
    {
        Assert.SkipWhen(NoOpenAIKeySet, "Requires OpenAI API Key");

        // Get the MCP client and tools from it.
        await using var client = await McpClient.CreateAsync(
            new StdioClientTransport(_fixture.EverythingServerTransportOptions),
            cancellationToken: TestExecutionContext.Current.CancellationToken);
        var mappedTools = await client.ListToolsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
        ...
        var response = await chatClient.GetResponseAsync(messages, new() { Tools = [.. mappedTools], Temperature = 0 }, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task SetLoggingLevel_ReceivesLoggingMessages(string clientId)
    {
        ...
        // act
        await client.SetLoggingLevelAsync(LoggingLevel.Debug, options: null, TestExecutionContext.Current.CancellationToken);
        ...
        if (clientId == "everything")
        {
            ...
            await client.CallToolAsync("toggle-simulated-logging", new Dictionary<string, object?>(), cancellationToken: TestExecutionContext.Current.CancellationToken);
        }
    ...
    public async Task ListToolsAsync_WithRequestParams_ReturnsRawResult(string clientId)
    {
        ...
        var result = await client.ListToolsAsync(new ListToolsRequestParams(), TestExecutionContext.Current.CancellationToken);
    ...
    public async Task ListPromptsAsync_WithRequestParams_ReturnsRawResult(string clientId)
    {
        ...
        var result = await client.ListPromptsAsync(new ListPromptsRequestParams(), TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Completion_Stdio_GracefulDisposal_ReturnsStdioDetails()
    {
        ...
        var details = await client.Completion.WaitAsync(TestExecutionContext.Current.CancellationToken);
