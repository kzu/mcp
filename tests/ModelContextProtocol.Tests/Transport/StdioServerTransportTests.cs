...
public class StdioServerTransportTests : LoggedTest
{
    ...
    public async Task SendMessageAsync_Should_Send_Message()
    {
        ...
        await transport.SendMessageAsync(message, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task ReadMessagesAsync_Should_Read_Messages()
    {
        ...
        var canRead = await transport.MessageReader.WaitToReadAsync(TestExecutionContext.Current.CancellationToken);
    ...
    public async Task SendMessageAsync_Should_Preserve_Unicode_Characters()
    {
        ...
        output.SetLength(0);
        await transport.SendMessageAsync(chineseMessage, TestExecutionContext.Current.CancellationToken);
        ...
        // Clear output and send message
        output.SetLength(0);
        await transport.SendMessageAsync(emojiMessage, TestExecutionContext.Current.CancellationToken);
