...
public class McpProtocolExceptionDataTests : ClientServerTestBase
{
    ...
    public async Task Exception_With_Serializable_Data_Propagates_To_Client()
    {
        ...
        var exception = await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.CallToolAsync("throw_with_serializable_data", cancellationToken: TestExecutionContext.Current.CancellationToken));
    ...
    public async Task Exception_With_NonSerializable_Data_Still_Propagates_Error_To_Client()
    {
        ...
        // values filtered out.
        var exception = await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.CallToolAsync("throw_with_nonserializable_data", cancellationToken: TestExecutionContext.Current.CancellationToken));
    ...
    public async Task Exception_With_Only_NonSerializable_Data_Still_Propagates_Error_To_Client()
    {
        ...
        var exception = await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.CallToolAsync("throw_with_only_nonserializable_data", cancellationToken: TestExecutionContext.Current.CancellationToken));
