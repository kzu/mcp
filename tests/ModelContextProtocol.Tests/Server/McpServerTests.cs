...
public class McpServerTests : LoggedTest
{
    ...
    public async Task RunAsync_Should_Throw_InvalidOperationException_If_Already_Running()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<InvalidOperationException>(() => server.RunAsync(TestExecutionContext.Current.CancellationToken));
    ...
    public async Task SampleAsync_Should_SendRequest()
    {
        ...
        await using var server = McpServer.Create(transport, _options, LoggerFactory);
        var runTask = server.RunAsync(TestExecutionContext.Current.CancellationToken);
        await InitializeServerAsync(transport, new ClientCapabilities { Sampling = new SamplingCapability() }, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task RequestRootsAsync_Should_SendRequest()
    {
        ...
        await using var server = McpServer.Create(transport, _options, LoggerFactory);
        var runTask = server.RunAsync(TestExecutionContext.Current.CancellationToken);
        await InitializeServerAsync(transport, new ClientCapabilities { Roots = new RootsCapability() }, TestExecutionContext.Current.CancellationToken);
...
#pragma warning restore MCPEXP001
    ...
    public async Task Completion_AutoPopulated_FromPromptAllowedValues()
    {
        ...
        var response = await receivedMessage.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Can_Handle_Call_Tool_Requests_With_McpProtocolException()
    {
        ...
        var error = await receivedMessage.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Can_SendMessage_Before_RunAsync()
    {
        ...
        await server.SendMessageAsync(logNotification, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Server_IgnoresCancellationNotificationForInitializeRequest()
    {
        ...
        await transport.SendClientMessageAsync(initializeRequest, TestExecutionContext.Current.CancellationToken);
        ...
        var response = await initResponseTcs.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task RunAsync_WaitsForInFlightHandlersBeforeReturning()
    {
        ...
        await handlerStarted.Task.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
        ...
        await runTask.WaitAsync(TestConstants.DefaultTimeout, TestExecutionContext.Current.CancellationToken);
...
#pragma warning restore MCPEXP002
    ...
    public async Task NotifyProgress_Should_Be_Handled()
    {
        ...
        Task serverTask = server.RunAsync(TestExecutionContext.Current.CancellationToken);
    ...
    public async Task NotifyProgressAsync_WithRequestParams_SendsNotification()
    {
        ...
        await server.NotifyProgressAsync(progressParams, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task NotifyProgressAsync_WithRequestParams_NullThrows()
    {
        ...
        await Assert.ThrowsAsync<ArgumentNullException>("requestParams",
            () => server.NotifyProgressAsync((ProgressNotificationParams)null!, TestExecutionContext.Current.CancellationToken));
    }
}
