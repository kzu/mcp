...
{
    private static CancellationToken CancellationToken => TestExecutionContext.Current.CancellationToken;
    ...
    {
        // Arrange
        var originalSessionId = "session-æ—¥æœ¬èªž-Ã©mojis-ðŸŽ‰";
        var originalStreamId = "stream-ä¸­æ–‡-Ø§Ù„Ø¹Ø±Ø¨ÙŠØ©";
