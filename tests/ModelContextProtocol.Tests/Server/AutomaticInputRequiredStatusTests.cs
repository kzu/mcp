...
#pragma warning disable MCPEXP001 // Tasks feature is experimental
    ...
    public async Task TaskStatus_TransitionsToInputRequired_DuringSampleAsync()
    {
        ...
        await samplingRequestReceived.Task.WaitAsync(TestConstants.DefaultTimeout, TestContext.CurrentContext.CancellationToken);
        ...
        do
        {
            ...
            finalStatus = await taskStore.GetTaskAsync(mcpTask.TaskId, cancellationToken: TestContext.CurrentContext.CancellationToken);
            maxAttempts--;
        }
    ...
    public async Task TaskStatus_TransitionsToInputRequired_DuringElicitAsync()
    {
        ...
        await elicitationRequestReceived.Task.WaitAsync(TestConstants.DefaultTimeout, TestContext.CurrentContext.CancellationToken);
    ...
    public async Task TaskStatus_ReturnsToWorking_AfterSamplingCompletes()
    {
        ...
        var taskAfterSampling = await taskStore.GetTaskAsync(mcpTask.TaskId, cancellationToken: TestContext.CurrentContext.CancellationToken);
    ...
    public async Task TaskStatus_DoesNotChangeToInputRequired_ForNonTaskExecution()
    {
        ...
        var tasks = await taskStore.ListTasksAsync(cancellationToken: TestContext.CurrentContext.CancellationToken);
    ...
    private sealed class InputRequiredTestFixture : IAsyncDisposable
    {
            ...
            Action<McpClientOptions>? configureClient = null)
        {
            ...
            Client = McpClient.CreateAsync(
                ...
                cancellationToken: TestContext.CurrentContext.CancellationToken).GetAwaiter().GetResult();
        }
