...
public class McpServerTaskAugmentedValidationTests : LoggedTest
{
    ...
    public async Task CallToolAsTask_ThrowsError_WhenNoTaskStoreConfigured()
    {
        ...
        await using var client = await fixture.CreateClientAsync(TestExecutionContext.Current.CancellationToken);
    ...
    public async Task GetTaskAsync_WithNonexistentTaskId_ReturnsInvalidParamsError()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.GetTaskAsync("nonexistent-task-id-12345", cancellationToken: TestExecutionContext.Current.CancellationToken));
    ...
    public async Task GetTaskResultAsync_WithNonexistentTaskId_ReturnsInvalidParamsError()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.GetTaskResultAsync("nonexistent-task-id-12345", cancellationToken: TestExecutionContext.Current.CancellationToken));
    ...
    public async Task CancelTaskAsync_WithNonexistentTaskId_ReturnsError()
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<McpProtocolException>(async () =>
            await client.CancelTaskAsync("nonexistent-task-id-12345", cancellationToken: TestExecutionContext.Current.CancellationToken));
    ...
    public async Task GetTaskResultAsync_ReturnsImmediately_WhenTaskAlreadyComplete()
    {
        ...
        var result = await client.GetTaskResultAsync(taskId, cancellationToken: TestExecutionContext.Current.CancellationToken);
...
#pragma warning restore CS0162
    ...
    public async Task ListTasksAsync_ContainsAllTasksRetrievableByGet()
    {
        ...
        {
            var task = await client.GetTaskAsync(taskId, cancellationToken: TestExecutionContext.Current.CancellationToken);
            Assert.NotNull(task);
        }

        // Act - List all tasks
        var allTasks = await client.ListTasksAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task Task_IncludesTtlInResponse()
    {
        ...
        var taskStatus = await client.GetTaskAsync(callResult.Task.TaskId, cancellationToken: TestExecutionContext.Current.CancellationToken);
