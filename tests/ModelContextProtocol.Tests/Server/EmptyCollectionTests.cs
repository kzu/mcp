...
public class EmptyCollectionTests : ClientServerTestBase
{
    ...
    public async Task EmptyResourceCollection_CanAddResourcesDynamically()
    {
        ...
        var initialResources = await client.ListResourcesAsync(options: null, TestExecutionContext.Current.CancellationToken);
        ...
        var updatedResources = await client.ListResourcesAsync(options: null, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task EmptyToolCollection_CanAddToolsDynamically()
    {
        ...
        var initialTools = await client.ListToolsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
        ...
        var updatedTools = await client.ListToolsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken);
    ...
    public async Task EmptyPromptCollection_CanAddPromptsDynamically()
    {
        ...
        var initialPrompts = await client.ListPromptsAsync(options: null, TestExecutionContext.Current.CancellationToken);
        ...
        var updatedPrompts = await client.ListPromptsAsync(options: null, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task EmptyResourceCollection_CanCallReadResourceAfterAddingDynamically()
    {
        ...
        // Read the resource
        var result = await client.ReadResourceAsync("test://resource/dynamic", options: null, TestExecutionContext.Current.CancellationToken);
    ...
    public async Task EmptyToolCollection_CanCallToolAfterAddingDynamically()
    {
        ...
        // Call the tool
        var result = await client.CallToolAsync("dynamic_tool", cancellationToken: TestExecutionContext.Current.CancellationToken);
        Assert.NotNull(result);
    ...
    public async Task EmptyPromptCollection_CanGetPromptAfterAddingDynamically()
    {
        ...
        // Get the prompt
        var result = await client.GetPromptAsync("dynamic_prompt", cancellationToken: TestExecutionContext.Current.CancellationToken);
        Assert.NotNull(result);
...
public class NullCollectionTests : ClientServerTestBase
{
    ...
    public async Task ListFails()
    {
        ...
        await Assert.ThrowsAsync<McpProtocolException>(async () => await client.ListToolsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken));
        await Assert.ThrowsAsync<McpProtocolException>(async () => await client.ListPromptsAsync(cancellationToken: TestExecutionContext.Current.CancellationToken));
        await Assert.ThrowsAsync<McpProtocolException>(async () => await client.ListResourcesAsync(cancellationToken: TestExecutionContext.Current.CancellationToken));
    }
}
