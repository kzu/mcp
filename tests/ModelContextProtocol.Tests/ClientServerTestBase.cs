...
public abstract class ClientServerTestBase : LoggedTest, IAsyncDisposable
{
    ...
    private readonly CancellationTokenSource _cts = CancellationTokenSource.CreateLinkedTokenSource(TestContext.CurrentContext.CancellationToken);
        ...
        : base()
    {
        ...
        ServiceCollection.AddSingleton(LoggerProvider);
